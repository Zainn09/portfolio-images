#!/usr/bin/env python3
"""Update the root README Sprint 11 tracker after each website checkpoint."""
...
STATE = ROOT / "capture-progress-sprint-11.json"
START = "<!-- SPRINT_11_PROGRESS_START -->"
END = "<!-- SPRINT_11_PROGRESS_END -->"

PROJECTS = [
    ('95', 'Prime Baby Gear', 'https://primebabygear.com', 'UK retailer of premium baby gear: prams, travel systems, car seats, nursery furniture, and accessories'),
    ('96', 'Ollie Burwell', 'https://ollieburwell.com', 'Hand-batik luxury silk and voile sarongs, scarves, kaftans, and resort wear'),
    ('97', 'Nokoluxe Living', 'https://nokoluxe.com', 'Luxury outdoor furniture, fire tables, grills, saunas, and spa products'),
    ('98', 'Vintage Art Garage', 'https://vintageartgarage.com', 'Framed vintage automotive advertisements, classic car and truck prints, and retro wall art'),
    ('99', 'Paw by Four', 'https://pawbyfour.com', 'Canine-anxiety support: digital guides, lick mats, enrichment tools, and dog-safe nutrition'),
]
LABELS = {
    "pending": "⚪ Pending",
    "capturing": "🔵 Capturing",
...
def render(state: dict, final: bool) -> str:
    ...
    return "\n".join([
        ...
        "**Required minimum:** 40 unique static images and 4 verified playable MP4 videos from the four publicly reachable storefronts.", "", END,
    ])
...
def main(final: bool) -> None:
    ...
    if START not in text or END not in text:
        raise SystemExit("Sprint 11 README markers are missing")
    before, rest = text.split(START, 1)
    _, after = rest.split(END, 1)
    README.write_text(before + render(state, final) + after)
    print("Updated README.md Sprint 11 progress")
