...
const ROOT = path.resolve('QA-PORTFOLIO-ASSETS/Sprint-06');
...
const projects = [
  {
    id: '51', slug: 'judyp-apparel', folder: '51-judyp-apparel', name: 'JudyP Apparel', url: 'https://judypapparel.com',
    prefix: '51_judyp_apparel', kind: 'Women’s wrinkle-resistant travel clothing',
    signatureText: 'Best Sellers', listingUrl: '/collections/shop-all', listingText: 'Shop All',
    detailUrl: '/products/deborah-3-4-sleeve-v-neck-top', detailText: 'Deborah',
    highlightUrl: '/pages/travel-capsule', highlightText: 'Travel', highlightLabel: 'travel clothing edit',
    interactionUrl: '/collections/dresses-styles', interactionText: 'Dresses',
    flowLabels: ['Easy-care clothing', 'Shop all', 'Travel top detail'], videoSlug: 'travel_apparel_journey',
    videoPurpose: 'Travel-apparel discovery from easy-care collection to garment detail'
  },
  {
    id: '52', slug: 'lady-flora', folder: '52-lady-flora', name: 'Lady Flora', url: 'https://www.ladyflora.co.uk',
    prefix: '52_lady_flora', kind: 'Florist, bouquets, wedding flowers, and fragrances',
    signatureText: 'Shop Flowers', listingUrl: '/collections/flowers', listingText: 'Flowers',
    detailUrl: '/products/lady-flora-florist-choice', detailText: 'Florist Choice',
    highlightUrl: '/pages/wedding-flowers', highlightText: 'Weddings', highlightLabel: 'wedding flower service',
    interactionUrl: '/collections/shop-fragrances', interactionText: 'Fragrances',
    flowLabels: ['Floral gifting', 'Flower collection', 'Florist choice'], videoSlug: 'floral_gifting_journey',
    videoPurpose: 'Floral-gifting discovery from bouquet collection to florist-choice detail'
  },
  {
    id: '53', slug: 'nano-lamination', folder: '53-nano-lamination', name: 'Nano Lamination', url: 'https://www.nanolamination.com',
    prefix: '53_nano_lamination', kind: 'Professional hair smoothing and lamination treatments',
    signatureText: 'Professional Smoothing', listingUrl: '/collections/smoothing-treatments', listingText: 'Smoothing Treatments',
    detailUrl: null, detailText: 'Treatment',
    highlightUrl: '/pages/salon-locator', highlightText: 'Salon', highlightLabel: 'professional salon locator',
    interactionUrl: '/collections/smoothing-treatments', interactionText: 'Nano',
    flowLabels: ['Professional haircare', 'Smoothing treatments', 'Treatment detail'], videoSlug: 'hair_smoothing_journey',
    videoPurpose: 'Professional smoothing-treatment discovery from range to detail'
  },
  {
    id: '54', slug: 'canvasback-pets', folder: '54-canvasback-pets', name: 'Canvasback Pet Supplies', url: 'https://www.canvasbackpets.com',
    prefix: '54_canvasback_pets', kind: 'Pet food, toys, and supplies',
    signatureText: 'Popular collections', listingUrl: '/collections/dry-dog-food', listingText: 'Dry Dog Food',
    detailUrl: null, detailText: 'Dog',
    highlightUrl: '/pages/about-us', highlightText: 'Our Story', highlightLabel: 'pet store story and services',
    interactionUrl: '/collections/dog-toys', interactionText: 'Dog Toys',
    flowLabels: ['Pet essentials', 'Dog food range', 'Product detail'], videoSlug: 'pet_supplies_journey',
    videoPurpose: 'Pet-supplies discovery from dog-food collection to product detail'
  },
  {
    id: '55', slug: 'luxe-atelier', folder: '55-luxe-atelier', name: 'Luxe Atelier', url: 'https://luxeatelier.co.uk',
    prefix: '55_luxe_atelier', kind: 'Luxury women’s occasionwear and evening dresses',
    signatureText: 'View all products', listingUrl: '/collections/shop-new', listingText: 'Products',
    detailUrl: '/products/isadora', detailText: 'ISADORA',
    highlightUrl: '/products/mira-1', highlightText: 'MIRA', highlightLabel: 'Mira eveningwear detail',
    interactionUrl: '/products/hope', interactionText: 'HOPE',
    flowLabels: ['Occasionwear edit', 'New collection', 'Isadora detail'], videoSlug: 'occasionwear_journey',
    videoPurpose: 'Luxury occasionwear discovery from new collection to dress detail'
  },
  {
    id: '56', slug: 'eastern-inspiration', folder: '56-eastern-inspiration', name: 'Eastern Inspiration', url: 'https://easterninspiration.co.uk',
    prefix: '56_eastern_inspiration', kind: 'Ethically made artisan gifts and homeware',
    signatureText: 'Ethically Made Products', listingUrl: '/collections/all', listingText: 'Products',
    detailUrl: null, detailText: 'Gift',
    highlightUrl: '/', highlightText: 'Family-Run Business', highlightLabel: 'ethical artisan gift story',
    interactionUrl: '/collections/all', interactionText: 'Wooden',
    flowLabels: ['Ethical gifting', 'Artisan catalogue', 'Gift detail'], videoSlug: 'artisan_gift_journey',
    videoPurpose: 'Ethical artisan-gift discovery from brand story to product detail'
  },
  {
    id: '57', slug: 'pet-prestige-uk', folder: '57-pet-prestige-uk', name: 'Pet Prestige UK', url: 'https://petprestigeuk.com',
    prefix: '57_pet_prestige_uk', kind: 'Luxury pet beds, blankets, mats, and accessories',
    signatureText: 'Accessories', listingUrl: '/collections/all', listingText: 'Products',
    detailUrl: null, detailText: 'Bed',
    highlightUrl: '/collections/pet-prestige-brand', highlightText: 'Prestige Collection', highlightLabel: 'Prestige pet bed collection',
    interactionUrl: '/collections/cat-products', interactionText: 'Cat Products',
    flowLabels: ['Luxury pet comfort', 'Product catalogue', 'Pet bed detail'], videoSlug: 'luxury_pet_journey',
    videoPurpose: 'Luxury pet-product discovery from Prestige collection to bed detail'
  },
  {
    id: '58', slug: 'midland-textiles', folder: '58-midland-textiles', name: 'Midland Textiles', url: 'https://midlandtextiles.co.uk',
    prefix: '58_midland_textiles', kind: 'Dressmaking, craft, lace, and apparel fabrics',
    signatureText: 'Collection Trending Product', listingUrl: '/collections/all', listingText: 'Products',
    detailUrl: '/products/black-ditsy-floral-georgette-dress-fabric-150cm-wide-m2149', detailText: 'Black Ditsy Floral',
    highlightUrl: '/products/ivory-cotton-rich-crochet-lace-fabric-150cm-wide', highlightText: 'Ivory', highlightLabel: 'crochet lace fabric detail',
    interactionUrl: '/products/linen-viscose-dress-fabric-137cm-wide-m2134', interactionText: 'Linen Viscose',
    flowLabels: ['Fabric selection', 'Textile catalogue', 'Georgette detail'], videoSlug: 'fabric_discovery_journey',
    videoPurpose: 'Dress-fabric discovery from textile catalogue to material detail'
  },
  {
    id: '59', slug: 'ba-squared-fitness', folder: '59-ba-squared-fitness', name: 'BA² Fitness', url: 'https://basquaredfitness.com',
    prefix: '59_ba_squared_fitness', kind: 'Performance fitness apparel',
    signatureText: 'THE BA² TRILOGY COLLECTION', listingUrl: '/collections/ba2-trilogy-collection', listingText: 'Foundation',
    detailUrl: '/products/performance-hoodie-black', detailText: 'Performance Hoodie',
    highlightUrl: '/products/ba2-foundation-tee', highlightText: 'Foundation Tee', highlightLabel: 'Foundation fitness tee',
    interactionUrl: '/products/ba2-control-the-work-tee', interactionText: 'Control The Work',
    flowLabels: ['Performance mindset', 'Trilogy collection', 'Hoodie detail'], videoSlug: 'fitness_apparel_journey',
    videoPurpose: 'Performance-apparel discovery from Trilogy collection to hoodie detail'
  },
  {
    id: '60', slug: 'belo-jewelry', folder: '60-belo-jewelry', name: 'Belo Jewelry', url: 'https://belojewelry.com',
    prefix: '60_belo_jewelry', kind: 'Handcrafted crystal and symbolic jewelry',
    signatureText: 'Most Loved Designs', listingUrl: '/collections/necklaces', listingText: 'Necklaces',
    detailUrl: '/products/the-clear-way', detailText: 'The Clear Way',
    highlightUrl: '/collections/crystals', highlightText: 'Crystals', highlightLabel: 'crystal collection',
    interactionUrl: '/collections/protection', interactionText: 'Grounding',
    flowLabels: ['Symbolic jewelry', 'Necklace collection', 'Design detail'], videoSlug: 'symbolic_jewelry_journey',
    videoPurpose: 'Symbolic crystal-jewelry discovery from necklace collection to design detail'
  }
];
...
async function captureProject(browser, project) {
  ...
  try {
    ...
    const result = {
      ...
      images: captures.map(c => ({ ...c, path: `QA-PORTFOLIO-ASSETS/Sprint-06/${project.folder}/images/${c.file}` })),
      videos: [{ ...video, path: `QA-PORTFOLIO-ASSETS/Sprint-06/${project.folder}/video/${video.file}`, thumbnailPath: `QA-PORTFOLIO-ASSETS/Sprint-06/${project.folder}/video/${video.thumbnail}` }],
      notes
    };
...
async function createBrowser(manifest) {
  ...
  await fs.writeFile('asset-browser/manifest-sprint-06.json', JSON.stringify(manifest, null, 2));
}
...
async function updateRootProgress(results, stage, activeProject = null, blocked = false) {
  ...
  await fs.writeFile('capture-progress-sprint-06.json', JSON.stringify(progress, null, 2));
  ...
  await fs.mkdir('asset-browser', { recursive: true });
  await fs.writeFile('asset-browser/manifest-sprint-06.json', JSON.stringify({
    title: 'QA Portfolio Visual Assets — Sprint 6', generated: CAPTURE_DATE,
    totalImages, totalVideos, projects: results
  }, null, 2));
  await execFileAsync('python3', ['scripts/update_readme_sprint06.py']);
...
async function publishCheckpoint(project) {
  ...
  await execFileAsync('git', ['add', 'README.md', 'capture-progress-sprint-06.json', 'asset-browser/manifest-sprint-06.json', 'asset-browser/manifest.json', path.join(ROOT, project.folder)]);
  await execFileAsync('git', ['commit', '-m', `Add Sprint 6 ${project.id} ${project.name} asset checkpoint [skip ci]`]);
...
async function publishBlockedProgress(project) {
  ...
  await execFileAsync('git', ['add', 'README.md', 'capture-progress-sprint-06.json', 'asset-browser/manifest-sprint-06.json', 'asset-browser/manifest.json']);
  const commit = await execFileAsync('git', ['commit', '-m', `Document Sprint 6 ${project.id} capture interruption [skip ci]`]).catch(() => null);
  if (commit) {
    await execFileAsync('git', ['fetch', 'origin', branch]);
    await execFileAsync('git', ['rebase', 'FETCH_HEAD']);
...
async function main() {
  ...
  const manifest = { title: 'QA Portfolio Visual Assets — Sprint 6', generated: CAPTURE_DATE, totalImages, totalVideos, projects: results };
  await createBrowser(manifest);
  await fs.writeFile('capture-report-sprint-06.json', JSON.stringify(manifest, null, 2));
  await fs.rm(TMP, { recursive: true, force: true });
  console.log(`\nSprint 6 capture complete: ${totalImages} images, ${totalVideos} videos.`);
