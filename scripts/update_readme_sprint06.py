#!/usr/bin/env python3
"""Update the root README Sprint 6 tracker after each website checkpoint."""
...
STATE = ROOT / "capture-progress-sprint-06.json"
START = "<!-- SPRINT_06_PROGRESS_START -->"
END = "<!-- SPRINT_06_PROGRESS_END -->"

PROJECTS = [
    ("51", "JudyP Apparel", "https://judypapparel.com", "Women’s wrinkle-resistant travel clothing"),
    ("52", "Lady Flora", "https://www.ladyflora.co.uk", "Florist, bouquets, wedding flowers, and fragrances"),
    ("53", "Nano Lamination", "https://www.nanolamination.com", "Professional hair smoothing and lamination treatments"),
    ("54", "Canvasback Pet Supplies", "https://www.canvasbackpets.com", "Pet food, toys, and supplies"),
    ("55", "Luxe Atelier", "https://luxeatelier.co.uk", "Luxury women’s occasionwear and evening dresses"),
    ("56", "Eastern Inspiration", "https://easterninspiration.co.uk", "Ethically made artisan gifts and homeware"),
    ("57", "Pet Prestige UK", "https://petprestigeuk.com", "Luxury pet beds, blankets, mats, and accessories"),
    ("58", "Midland Textiles", "https://midlandtextiles.co.uk", "Dressmaking, craft, lace, and apparel fabrics"),
    ("59", "BA² Fitness", "https://basquaredfitness.com", "Performance fitness apparel"),
    ("60", "Belo Jewelry", "https://belojewelry.com", "Handcrafted crystal and symbolic jewelry"),
]
LABELS = {
    "pending": "⚪ Pending",
    "capturing": "🔵 Capturing",
...
def main(final: bool) -> None:
    ...
    if START not in text or END not in text:
        raise SystemExit("Sprint 6 README markers are missing")
    before, rest = text.split(START, 1)
    _, after = rest.split(END, 1)
    README.write_text(before + render(state, final) + after)
    print("Updated README.md Sprint 6 progress")
