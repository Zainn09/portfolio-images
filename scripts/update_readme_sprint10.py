#!/usr/bin/env python3
"""Update the root README Sprint 10 tracker after each website checkpoint."""
...
STATE = ROOT / "capture-progress-sprint-10.json"
START = "<!-- SPRINT_10_PROGRESS_START -->"
END = "<!-- SPRINT_10_PROGRESS_END -->"

PROJECTS = [
    ('91', 'Morris Manufacturing', 'https://morrismfg.com', 'American precision machined metal parts manufacturing'),
    ('92', 'TMI Products', 'https://www.tmiproducts.com', 'Custom automotive interiors, seats, materials, and vehicle restoration parts'),
    ('93', 'American Hose & Gasket', 'https://americanhosegasket.com', 'American industrial hose, fittings, and custom assembly solutions'),
    ('94', 'Rock Angel Creations', 'https://rockangelcreations.com', 'Handcrafted gothic and metal-inspired clothing and accessories'),
]
LABELS = {
    "pending": "⚪ Pending",
    "capturing": "🔵 Capturing",
...
def render(state: dict, final: bool) -> str:
    ...
    return "\n".join([
        ...
        "**Required minimum:** 40 unique static images and 4 verified playable MP4 videos.", "", END,
    ])
...
def main(final: bool) -> None:
    ...
    if START not in text or END not in text:
        raise SystemExit("Sprint 10 README markers are missing")
    before, rest = text.split(START, 1)
    _, after = rest.split(END, 1)
    README.write_text(before + render(state, final) + after)
    print("Updated README.md Sprint 10 progress")
