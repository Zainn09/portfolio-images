...
const ROOT = path.resolve('QA-PORTFOLIO-ASSETS/Sprint-02');
...
const projects = [
  {
    id: '11', slug: 'globy-glen-skin', folder: '11-globy-glen-skin', name: 'Glo by Glen Skin', url: 'https://www.globyglenskin.com',
    prefix: '11_globy_glen_skin', kind: 'Medical-grade skincare',
    signatureText: 'Glo Serums', listingUrl: '/collections/all', listingText: 'Products',
    detailUrl: '/products/clarte-phyto-corrector', detailText: 'Clarté Phyto Corrector',
    highlightUrl: '/collections/anti-aging', highlightText: 'Anti-Aging', highlightLabel: 'targeted skincare collection',
    interactionUrl: '/products/gluhen-tone-perfecting-serum', interactionText: 'Glühen',
    flowLabels: ['Rare serums', 'Skincare catalogue', 'Serum detail'], videoSlug: 'skincare_journey',
    videoPurpose: 'Medical-grade skincare journey from hero to serum detail'
  },
  {
    id: '12', slug: 'funky-flickr-boyz-gear', folder: '12-funky-flickr-boyz-gear', name: 'Funky Flickr Boyz Gear', url: 'https://funkyflickrboyzgear.com',
    prefix: '12_funky_flickr_boyz_gear', kind: 'Performance wrestling gear',
    signatureText: 'SHOP THE CURRENT LINEUP', listingUrl: '/collections/all-products', listingText: 'Wrestling',
    detailUrl: '/products/ffb-postlude-watermelon-wrestling-shoes', detailText: 'Postlude Watermelon',
    highlightUrl: '/pages/ffb', highlightText: 'Funky', highlightLabel: 'wrestling brand story',
    interactionUrl: '/collections/nidrogen-series-05', interactionText: 'SERIES 05',
    flowLabels: ['Built for wrestling', 'Current lineup', 'Shoe detail'], videoSlug: 'wrestling_gear_journey',
    videoPurpose: 'Wrestling footwear discovery from campaign to shoe detail'
  },
  {
    id: '13', slug: 'my-rug-world', folder: '13-my-rug-world', name: 'My Rug World', url: 'https://myrugworld.com',
    prefix: '13_my_rug_world', kind: 'Rugs and guided shape discovery',
    signatureText: 'New Arrivals', listingUrl: '/collections/all', listingText: 'Rugs',
    detailUrl: '/products/merit-6657', detailText: 'Merit 6657',
    highlightUrl: '/', highlightText: 'Select a Shape', highlightLabel: 'guided rug finder',
    interactionUrl: '/products/callie-4972', interactionText: 'Size',
    flowLabels: ['Rug discovery', 'Rug catalogue', 'Merit rug detail'], videoSlug: 'rug_discovery_journey',
    videoPurpose: 'Guided rug discovery and product detail journey'
  },
  {
    id: '14', slug: 'gorgeous-alpacas', folder: '14-gorgeous-alpacas', name: 'Gorgeous Alpacas', url: 'https://gorgeousalpacas.co.uk',
    prefix: '14_gorgeous_alpacas', kind: 'Yarn, craft kits, and knitwear',
    signatureText: 'Gorgeous', listingUrl: '/collections/all', listingText: 'Products',
    detailUrl: null, detailText: 'Quantity',
    highlightUrl: '/collections/yarn', highlightText: 'Yarn', highlightLabel: 'alpaca yarn collection',
    interactionUrl: '/collections/craft-kits', interactionText: 'Kit',
    flowLabels: ['Alpaca craft', 'Yarn and knitwear', 'Product detail'], videoSlug: 'craft_journey',
    videoPurpose: 'Alpaca yarn and craft product discovery journey'
  },
  {
    id: '15', slug: 'the-bread-essentials', folder: '15-the-bread-essentials', name: 'The Bread Essentials', url: 'https://www.thebreadessentials.com',
    prefix: '15_the_bread_essentials', kind: 'Gluten-free bakery and grocery',
    signatureText: 'BEST SELLERS', listingUrl: '/collections/all', listingText: 'Products',
    detailUrl: '/products/gluten-free-rosemary-bread', detailText: 'Rosemary Sourdough Bread',
    highlightUrl: '/collections/bread', highlightText: 'Bread', highlightLabel: 'gluten-free bread collection',
    interactionUrl: '/collections/cakes', interactionText: 'Cakes',
    flowLabels: ['Gluten-free bakery', 'Bakery catalogue', 'Sourdough detail'], videoSlug: 'bakery_journey',
    videoPurpose: 'Gluten-free bakery discovery and product journey'
  },
  {
    id: '16', slug: 'something-pretty-floral', folder: '16-something-pretty-floral', name: 'Something Pretty Floral', url: 'https://somethingprettyfloral.com',
    prefix: '16_something_pretty_floral', kind: 'Luxury floral studio and events',
    signatureText: 'BOUTIQUE FLORAL STUDIO', listingUrl: '/collections/all-floral', listingText: 'Floral',
    detailUrl: '/products/the-amour', detailText: 'Amour',
    highlightUrl: '/pages/contact', highlightText: 'Contact', highlightLabel: 'consultation contact flow',
    interactionUrl: '/collections/birthday-floral', interactionText: 'Birthday',
    flowLabels: ['Floral studio', 'Arrangement collection', 'Arrangement detail'], videoSlug: 'floral_journey',
    videoPurpose: 'Luxury floral shopping and consultation discovery journey'
  },
  {
    id: '17', slug: 'london-flower-academy', folder: '17-london-flower-academy', name: 'London Flower Academy', url: 'https://londonfloweracademy.com',
    prefix: '17_london_flower_academy', kind: 'Floral design workshops',
    signatureText: 'Why Choose', listingUrl: '/collections/all', listingText: 'Workshop',
    detailUrl: null, detailText: 'Workshop',
    highlightUrl: '/pages/contact', highlightText: 'Contact', highlightLabel: 'academy enquiry flow',
    interactionUrl: '/collections/all', interactionText: 'Book',
    flowLabels: ['Floral education', 'Workshop classes', 'Class detail'], videoSlug: 'workshop_journey',
    videoPurpose: 'Floral workshop discovery and booking-information journey'
  },
  {
    id: '18', slug: 'monsoon-flowers', folder: '18-monsoon-flowers', name: 'Monsoon Flowers', url: 'https://monsoonflowers.com',
    prefix: '18_monsoon_flowers', kind: 'Same-day flowers and curated gifts',
    signatureText: 'Where we deliver to', listingUrl: '/collections/floral', listingText: 'Floral',
    detailUrl: null, detailText: 'Add to Cart',
    highlightUrl: '/pages/areas-we-serve', highlightText: 'Delivery', highlightLabel: 'delivery coverage information',
    interactionUrl: '/collections/lavish-gifts', interactionText: 'Gifts',
    flowLabels: ['Same-day flowers', 'Floral collection', 'Arrangement detail'], videoSlug: 'flower_delivery_journey',
    videoPurpose: 'Same-day flower discovery and arrangement detail journey'
  },
  {
    id: '19', slug: 'electrocity-bikes', folder: '19-electrocity-bikes', name: 'ElectroCity Bikes', url: 'https://electrocitybikes.co.uk',
    prefix: '19_electrocity_bikes', kind: 'Electric bikes and conversion kits',
    signatureText: 'Powering', listingUrl: '/collections/new-ebike', listingText: 'Bike',
    detailUrl: null, detailText: 'Add to cart',
    highlightUrl: '/', highlightText: 'Eco Friendly Rides', highlightLabel: 'electric mobility benefits',
    interactionUrl: '/collections/all', interactionText: 'Products',
    flowLabels: ['Electric mobility', 'E-bike collection', 'Bike detail'], videoSlug: 'ebike_journey',
    videoPurpose: 'Electric bike discovery and product-detail journey'
  },
  {
    id: '20', slug: 'moor-body-care', folder: '20-moor-body-care', name: 'Moor Body Care', url: 'https://www.moorbodycare.co.uk',
    prefix: '20_moor_body_care', kind: 'Moor therapy skincare',
    signatureText: 'Would you like to know our origins', listingUrl: '/collections/moor-spa', listingText: 'Moor',
    detailUrl: '/products/hydrating-herbal-bath', detailText: 'Hydrating Herbal Bath',
    highlightUrl: '/pages/moor-spa-history', highlightText: 'History', highlightLabel: 'moor therapy heritage',
    interactionUrl: '/collections/face-masks', interactionText: 'Mask',
    flowLabels: ['Moor therapy', 'Spa collection', 'Bath treatment detail'], videoSlug: 'moor_spa_journey',
    videoPurpose: 'Moor therapy skincare and treatment-detail journey'
  }
];
...
async function captureProject(browser, project) {
  ...
  try {
    ...
    const result = {
      ...
      images: captures.map(c => ({ ...c, path: `QA-PORTFOLIO-ASSETS/Sprint-02/${project.folder}/images/${c.file}` })),
      videos: [{ ...video, path: `QA-PORTFOLIO-ASSETS/Sprint-02/${project.folder}/video/${video.file}`, thumbnailPath: `QA-PORTFOLIO-ASSETS/Sprint-02/${project.folder}/video/${video.thumbnail}` }],
      notes
    };
...
async function createBrowser(manifest) {
  ...
  await fs.writeFile('asset-browser/manifest-sprint-02.json', JSON.stringify(manifest, null, 2));
}
...
async function main() {
  ...
  const readme = `# QA Portfolio Visual Asset Library — Sprint 2\n\n` +
  ...
  const manifest = { title: 'QA Portfolio Visual Assets — Sprint 2', generated: CAPTURE_DATE, totalImages, totalVideos, projects: results };
  await createBrowser(manifest);
  await fs.writeFile('capture-report-sprint-02.json', JSON.stringify(manifest, null, 2));
  await fs.rm(TMP, { recursive: true, force: true });
  console.log(`\nSprint 2 capture complete: ${totalImages} images, ${totalVideos} videos.`);
