...
const ROOT = path.resolve('QA-PORTFOLIO-ASSETS/Sprint-07');
...
const projects = [
  {
    id: '61', slug: 'rocket-krunch', folder: '61-rocket-krunch', name: 'Rocket Krunch', url: 'https://www.rocketkrunch.com',
    prefix: '61_rocket_krunch', kind: 'Freeze-dried candy, fruit, and pantry foods',
    signatureText: 'The Pantry by Rocket Krunch', listingUrl: '/collections/new-arrivals', listingText: 'New Arrivals',
    detailUrl: null, detailText: 'Quantity',
    highlightUrl: '/collections/the-pantry-by-rocket-krunch', highlightText: 'Freeze Dried Fruits', highlightLabel: 'freeze-dried pantry collection',
    interactionUrl: '/collections/all', interactionText: 'Krunch Pack Builder',
    flowLabels: ['Cosmic candy', 'New arrivals', 'Treat detail'], videoSlug: 'freeze_dried_treat_journey',
    videoPurpose: 'Freeze-dried treat discovery from new arrivals to product detail'
  },
  {
    ...
    interactionUrl: '/products/autumn-leaves-and-flowers-with-bow-silk-scarf-phone-cases', interactionText: 'Autumn Leaves',
    flowLabels: ['Case design', 'Accessories catalogue', 'Painter’s case'], videoSlug: 'phone_case_journey',
    videoPurpose: 'Designer phone-case discovery from catalogue to protective-case detail'
  },
  {
    id: '63', slug: 'total-beauty-experience', folder: '63-total-beauty-experience', name: 'Total Beauty Experience', url: 'https://totalbeautyexp.com',
    prefix: '63_total_beauty_experience', kind: 'Beauty, haircare, skincare, fragrance, and personal care retailer',
    signatureText: 'Established in 1994', listingUrl: '/collections/image', listingText: 'IMAGE',
    detailUrl: null, detailText: 'Quantity',
    highlightUrl: '/collections/skincare-tools', highlightText: 'Skincare Tools', highlightLabel: 'professional skincare tools',
    interactionUrl: '/collections/home-fragrance', interactionText: 'HOME FRAGRANCE',
    flowLabels: ['Beauty destination', 'Skincare range', 'Product detail'], videoSlug: 'beauty_retail_journey',
    videoPurpose: 'Beauty-product discovery from professional skincare range to product detail'
  },
  {
    id: '64', slug: 'john-white-shoes', folder: '64-john-white-shoes', name: 'John White Shoes', url: 'https://www.johnwhiteshoes.com',
    prefix: '64_john_white_shoes', kind: 'British heritage men’s leather footwear',
    signatureText: 'since 1919', listingUrl: '/collections/all-shoes', listingText: 'All Our Products',
    detailUrl: null, detailText: 'Size',
    highlightUrl: '/collections/boots', highlightText: 'Boots', highlightLabel: 'heritage boots collection',
    interactionUrl: '/collections/seconds', interactionText: 'Quality Seconds',
    flowLabels: ['British shoemaking', 'All footwear', 'Shoe detail'], videoSlug: 'heritage_footwear_journey',
    videoPurpose: 'Heritage-footwear discovery from full collection to shoe detail'
  },
  {
    id: '65', slug: 'love-renaissance', folder: '65-love-renaissance', name: 'Love Renaissance', url: 'https://love-renaissance.shop',
    prefix: '65_love_renaissance', kind: 'Japanese-crafted skincare, haircare, wellness, and fragrance',
    signatureText: 'Japanese craftsmanship', listingUrl: '/collections/parfume', listingText: 'Parfums',
    detailUrl: '/products/kotohogi-conditioning-baby-cream', detailText: 'Highlighted Ingredients',
    highlightUrl: '/collections/special-treatment', highlightText: 'Focused Care', highlightLabel: 'focused skincare collection',
    interactionUrl: '/products/2451', interactionText: 'AROUSE',
    flowLabels: ['Japanese beauty', 'Signature parfums', 'Baby cream detail'], videoSlug: 'japanese_beauty_journey',
    videoPurpose: 'Japanese beauty discovery from fragrance collection to skincare detail'
  },
  {
    id: '66', slug: 'hughies-dog-accessories', folder: '66-hughies-dog-accessories', name: 'Hughie’s Dog Accessories', url: 'https://hughies-dog-accessories.com',
    prefix: '66_hughies_dog_accessories', kind: 'Handmade sustainable dog collars, bandanas, and toys',
    signatureText: 'Why Choose Hughie’s', listingUrl: '/collections/all', listingText: 'Products',
    detailUrl: null, detailText: 'Size',
    highlightUrl: '/collections/dog-bones', highlightText: 'Handmade Soft Dog Bone Toys', highlightLabel: 'upcycled dog toy collection',
    interactionUrl: '/collections/best-sellers', interactionText: 'Best Selling Dog Accessories',
    flowLabels: ['Sustainable accessories', 'Full catalogue', 'Accessory detail'], videoSlug: 'sustainable_dog_accessories_journey',
    videoPurpose: 'Sustainable dog-accessory discovery from catalogue to handmade item detail'
  },
  {
    id: '67', slug: 'vezorla', folder: '67-vezorla', name: 'Vezorla', url: 'https://www.vezorla.com',
    prefix: '67_vezorla', kind: 'Spanish extra-virgin olive oil and gourmet foods',
    signatureText: 'The Flavours I Grew Up With', listingUrl: '/collections/all-products', listingText: 'All Products',
    detailUrl: null, detailText: 'Quantity',
    highlightUrl: '/collections/extra-virgin-olive-oil', highlightText: 'Spanish Extra Virgin Olive Oil', highlightLabel: 'Spanish olive oil collection',
    interactionUrl: '/collections', interactionText: 'Craft Dark Chocolate',
    flowLabels: ['Andalusian provenance', 'Gourmet range', 'Olive oil detail'], videoSlug: 'olive_oil_journey',
    videoPurpose: 'Spanish gourmet-food discovery from collection to olive-oil detail'
  },
  {
    id: '68', slug: 'op-fashion-fabrics', folder: '68-op-fashion-fabrics', name: 'O & P Fashion Fabrics', url: 'https://opfashionfabrics.co.uk',
    prefix: '68_op_fashion_fabrics', kind: 'Wholesale and small-quantity fashion fabrics', detailSlug: 'company_story',
    signatureText: 'A little bit about us', listingUrl: '/our-ranges/', listingText: 'Chiffon',
    detailUrl: '/about/', detailText: 'Our Story',
    highlightUrl: '/our-ranges/', highlightText: 'Brocades & Jacquards', highlightLabel: 'brocade and jacquard range',
    interactionUrl: '/our-ranges/', interactionText: '100% Pure Silk',
    flowLabels: ['Textile warehouse', 'Fabric ranges', 'Company story'], videoSlug: 'fashion_fabric_journey',
    videoPurpose: 'Fashion-fabric discovery from warehouse story to material ranges'
  },
  {
    id: '69', slug: 'gym-emotion', folder: '69-gym-emotion', name: 'Gym Emotion', url: 'https://gymemotion.com',
    prefix: '69_gym_emotion', kind: 'Commercial and home gym equipment',
    signatureText: 'See Our Categories', listingUrl: '/collections/gym-systems', listingText: 'Gym Systems',
    detailUrl: null, detailText: 'View full details',
    highlightUrl: '/collections/dumbbells', highlightText: 'Dumbbells', highlightLabel: 'strength dumbbell equipment',
    interactionUrl: '/collections/kettlebells', interactionText: 'Kettlebells',
    flowLabels: ['Training equipment', 'Gym systems', 'Equipment detail'], videoSlug: 'gym_equipment_journey',
    videoPurpose: 'Gym-equipment discovery from systems collection to equipment detail'
  },
  {
    id: '70', slug: 'elysian-blooms', folder: '70-elysian-blooms', name: 'Elysian Blooms', url: 'https://www.elysianblooms.co.uk',
    prefix: '70_elysian_blooms', kind: 'Surrey gift, wedding, sympathy, and occasion florist', detailSlug: 'bouquet_detail',
    signatureText: 'Our Best Sellers', listingUrl: '/shop-online.htm', listingText: 'Gift Occasions',
    detailUrl: '/design-20264013/the-autumn-woodland.htm', detailText: 'Seasonal Selection',
    highlightUrl: '/weddings.htm', highlightText: 'Wedding', highlightLabel: 'wedding flower service',
    interactionUrl: '/flower-delivery/Datchet-Common.htm', interactionText: 'Datchet Common',
    flowLabels: ['Local florist', 'Gift flowers', 'Seasonal bouquet'], videoSlug: 'florist_journey',
    videoPurpose: 'Local-florist discovery from gift flowers to seasonal bouquet detail'
  }
];
...
async function captureProject(browser, project) {
  ...
  try {
    ...
    const result = {
      ...
      images: captures.map(c => ({ ...c, path: `QA-PORTFOLIO-ASSETS/Sprint-07/${project.folder}/images/${c.file}` })),
      videos: [{ ...video, path: `QA-PORTFOLIO-ASSETS/Sprint-07/${project.folder}/video/${video.file}`, thumbnailPath: `QA-PORTFOLIO-ASSETS/Sprint-07/${project.folder}/video/${video.thumbnail}` }],
      notes
    };
...
async function createBrowser(manifest) {
  ...
  await fs.writeFile('asset-browser/manifest-sprint-07.json', JSON.stringify(manifest, null, 2));
}
...
async function updateRootProgress(results, stage, activeProject = null, blocked = false, blockedNote = '') {
  ...
  await fs.writeFile('capture-progress-sprint-07.json', JSON.stringify(progress, null, 2));
  ...
  await fs.mkdir('asset-browser', { recursive: true });
  await fs.writeFile('asset-browser/manifest-sprint-07.json', JSON.stringify({
    title: 'QA Portfolio Visual Assets — Sprint 7', generated: CAPTURE_DATE,
    totalImages, totalVideos, projects: results
  }, null, 2));
  await execFileAsync('python3', ['scripts/update_readme_sprint07.py']);
...
async function publishCheckpoint(project) {
  ...
  await execFileAsync('git', ['add', 'README.md', 'capture-progress-sprint-07.json', 'asset-browser/manifest-sprint-07.json', 'asset-browser/manifest.json', path.join(ROOT, project.folder)]);
  await execFileAsync('git', ['commit', '-m', `Add Sprint 7 ${project.id} ${project.name} asset checkpoint [skip ci]`]);
...
async function publishBlockedProgress(project) {
  ...
  await execFileAsync('git', ['add', 'README.md', 'capture-progress-sprint-07.json', 'asset-browser/manifest-sprint-07.json', 'asset-browser/manifest.json']);
  const commit = await execFileAsync('git', ['commit', '-m', `Document Sprint 7 ${project.id} capture interruption [skip ci]`]).catch(() => null);
  if (commit) {
    await execFileAsync('git', ['fetch', 'origin', branch]);
    await execFileAsync('git', ['rebase', 'FETCH_HEAD']);
...
async function main() {
  ...
  await updateRootProgress(results, 'All Sprint 7 project assets generated; final QA pending');
  const totalImages = results.reduce((sum, p) => sum + p.images.length, 0);
  const totalVideos = results.reduce((sum, p) => sum + p.videos.length, 0);
  const readme = `# QA Portfolio Visual Asset Library — Sprint 7\n\n` +
  ...
  const manifest = { title: 'QA Portfolio Visual Assets — Sprint 7', generated: CAPTURE_DATE, totalImages, totalVideos, projects: results };
  await createBrowser(manifest);
  await fs.writeFile('capture-report-sprint-07.json', JSON.stringify(manifest, null, 2));
  await fs.rm(TMP, { recursive: true, force: true });
  console.log(`\nSprint 7 capture complete: ${totalImages} images, ${totalVideos} videos.`);
