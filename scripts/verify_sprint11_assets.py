#!/usr/bin/env python3
"""Final Sprint 11 image, playable-video, naming, manifest, and ZIP QA."""
...
MANIFEST_FILE = ROOT / "asset-browser" / "manifest-sprint-11.json"
ZIP_FILE = ROOT / "QA-Portfolio-Sprint-11-Assets.zip"
...
if not ZIP_FILE.is_file():
    errors.append("Sprint 11 ZIP is missing")
else:
    with zipfile.ZipFile(ZIP_FILE) as archive:
        if archive.testzip():
            errors.append("Sprint 11 ZIP integrity failed")
        if "Sprint-11/README.md" not in archive.namelist():
            errors.append("Sprint 11 ZIP is missing the sprint README")
