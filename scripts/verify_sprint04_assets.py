#!/usr/bin/env python3
"""Final Sprint 4 image, playable-video, naming, manifest, and ZIP QA."""
...
MANIFEST_FILE = ROOT / "asset-browser" / "manifest-sprint-04.json"
ZIP_FILE = ROOT / "QA-Portfolio-Sprint-04-Assets.zip"
...
if not ZIP_FILE.is_file():
    errors.append("Sprint 4 ZIP is missing")
else:
    with zipfile.ZipFile(ZIP_FILE) as archive:
        if archive.testzip():
            errors.append("Sprint 4 ZIP integrity failed")
        if "Sprint-04/README.md" not in archive.namelist():
            errors.append("Sprint 4 ZIP is missing the sprint README")
