# The Scaff Shop — QA Portfolio Visual Assets

**Project:** The Scaff Shop  
**Website URL:** https://thescaffshop.com  
**Project type:** Reclaimed scaffold furniture and materials  
...
- `06_the_scaff_shop_mobile_project_specific_section_001.jpg` — Mobile project-specific section
- `06_the_scaff_shop_responsive_comparison_001.jpg` — Desktop / mobile responsive QA comparison
- `06_the_scaff_shop_qa_user_flow_sequence_001.jpg` — Three-state QA user-flow reference

## Video

- `06_the_scaff_shop_video_product_journey_001.mp4` — Reclaimed furniture discovery and product browsing flow
- `06_the_scaff_shop_video_product_journey_001.jpg` — Video poster / thumbnail
